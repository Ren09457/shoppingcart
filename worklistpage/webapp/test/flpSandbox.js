		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Total and Subtotal",
									"targetURL": "#comdemoworklistpage-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comdemoworklistpage-display": {
								"semanticObject": "comdemoworklistpage",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.demo.worklistpage",
									"url": sap.ui.require.toUrl("com/demo/worklistpage")
								}
							}
						}
					}
