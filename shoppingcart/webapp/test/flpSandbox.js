		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Shopping Cart",
									"targetURL": "#comdemoshoppingcart-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comdemoshoppingcart-display": {
								"semanticObject": "comdemoshoppingcart",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.demo.shoppingcart",
									"url": sap.ui.require.toUrl("com/demo/shoppingcart")
								}
							}
						}
					}
