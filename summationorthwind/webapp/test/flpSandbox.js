		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Summation",
									"targetURL": "#comdemosummationorthwind-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comdemosummationorthwind-display": {
								"semanticObject": "comdemosummationorthwind",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.demo.summationorthwind",
									"url": sap.ui.require.toUrl("com/demo/summationorthwind")
								}
							}
						}
					}
