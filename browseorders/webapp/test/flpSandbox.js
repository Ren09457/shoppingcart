		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Browseorders",
									"targetURL": "#comdemobrowseorders-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comdemobrowseorders-display": {
								"semanticObject": "comdemobrowseorders",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.demo.browseorders",
									"url": sap.ui.require.toUrl("com/demo/browseorders")
								}
							}
						}
					}
