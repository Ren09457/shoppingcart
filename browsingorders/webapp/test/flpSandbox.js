		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Orders",
									"targetURL": "#comdemobrowsingorders-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comdemobrowsingorders-display": {
								"semanticObject": "comdemobrowsingorders",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.demo.browsingorders",
									"url": sap.ui.require.toUrl("com/demo/browsingorders")
								}
							}
						}
					}
