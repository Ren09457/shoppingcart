		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Timesheet",
									"targetURL": "#comdemoemployeetimesheet-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comdemoemployeetimesheet-display": {
								"semanticObject": "comdemoemployeetimesheet",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.demo.employeetimesheet",
									"url": sap.ui.require.toUrl("com/demo/employeetimesheet")
								}
							}
						}
					}
